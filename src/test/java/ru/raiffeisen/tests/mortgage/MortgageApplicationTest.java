package ru.raiffeisen.tests.mortgage;
...
public class MortgageApplicationTest  extends BaseTests {

    @Test
    public void mortgageApplicationTest () {
        ...
        fillField(By.xpath("//*[@id='form']//input[@data-marker-field='fullName']"), "Иванов Иван Иванович");
